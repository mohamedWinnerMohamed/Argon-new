...
import { EditTripButton } from "../_components/edit-trip-button";
import { ToggleTripButton } from "../_components/toggle-button";
      ...
      return (
        <div className="flex flex-end gap-2">
          ...
          <DisableButtonForNonAdmin>
            <EditTripButton data={data} />
          </DisableButtonForNonAdmin>
          <DisableButtonForNonAdmin>
            <DeleteTripButton id={data.id} />
          </DisableButtonForNonAdmin>
          <DisableButtonForNonAdmin>
            <ToggleTripButton
              id={data.id}
              initialState={(data as any).isDone}
            />
          </DisableButtonForNonAdmin>
        </div>
      );
