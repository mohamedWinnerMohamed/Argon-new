...
import { createPassenger } from "@/apis/passenger-crud";
...
export default function Page() {
  ...
  async function onSubmit({ price, ...data }: CreatePassengerType) {
    ...
    setTicket({
      ...
      mediatorName: ticketData.mediatorName,
  ...
  return (
    <div className="p-4 overflow-y-auto">
      <p className="text-2xl font-bold">إضافة مسافر</p>
      <p className="text-muted-foreground">
        الرجاء ملئ الحقول التالية لإضافة مسافر جديد
      </p>
      <form
      ...
      >
        ...
        <div className="flex flex-col gap-3 w-full">
          <Label className="w-full" htmlFor="mediator-input">
            الوسيط
          </Label>
          <Input
            {...register("mediatorName")}
